 ...
 */
@Data
@Schema(name = "MesErpItemLogInfoResponse", description = "mes与ERP物料出入库流水表 详情返回信息")
public class MesErpItemLogInfoResponse implements Serializable {
