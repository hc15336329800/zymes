...
public class RequestResponseTool {
    ...
    /**
     * 转换输入的值与消息为json格式{"type":"type","status":"status","result":"result"}
     *
     * @param type
     * @param type
     * @return
     * @throws Exception
     */
    public static Map<String, Object> getJsonTypeMessage(String type, String status) {
        Map<String, Object> resultType = new HashMap<>();
        resultType.put("type", type);
        resultType.put("status", status);
        return resultType;
    }
